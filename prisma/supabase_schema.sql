...
create index if not exists workflows_tenant_id_client_id_idx on workflows(tenant_id, client_id);
create index if not exists tasks_tenant_id_workflow_id_idx on tasks(tenant_id, workflow_id);
create index if not exists tasks_assigned_to_idx on tasks(assigned_to);
create index if not exists blockers_tenant_id_status_idx on blockers(tenant_id, status);
create index if not exists blockers_task_id_status_idx on blockers(task_id, status);
