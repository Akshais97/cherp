...
create table if not exists tasks (
  ...
  title text not null,
  description text,
  status text not null default 'yet_to_start' check (status in ('yet_to_start', 'ongoing', 'blocked', 'completed', 'task_approved_by_manager', 'rework', 'task_approved_by_client')),
...
create table if not exists activity_logs (
  ...
  action_type text not null check (action_type in ('created', 'updated', 'status_changed', 'assigned', 'completed', 'blocked', 'resolved', 'archived', 'deleted')),
